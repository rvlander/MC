...
[dxu,dxd,dyu,dyd] = direct_method_triangle(nT,dXsdT,dYsdT,t0xs,t0ys,ind0xs,ind0ys);
sampling = t0ys(1):20:t0ys(end);

[nX,nY,signalx,signaly] = resample_hw_triangle(sampling,t0xs,t0ys,dxu,dxd,dyu,dyd,c,X(1),Y(1));
